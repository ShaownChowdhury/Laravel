...
<![endif]-->
    <a href="cart.html#top" class="back-to-top" id="backto-top"><i class="fal fa-arrow-up"></i></a>
    <!-- Start Header -->
                        ...
                        <div class="header-top-dropdown">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="cart.html#">English</a></li>
                                    <li><a class="dropdown-item" href="cart.html#">Arabic</a></li>
                                    <li><a class="dropdown-item" href="cart.html#">Spanish</a></li>
                                </ul>
                            </div>
                            <div class="dropdown">
                                <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="cart.html#">USD</a></li>
                                    <li><a class="dropdown-item" href="cart.html#">AUD</a></li>
                                    <li><a class="dropdown-item" href="cart.html#">EUR</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <li class="my-account">
                                ...
                                <div class="my-account-dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="cart.html#">Initiate return</a>
                                        </li>
                                        <li>
                                            <a href="cart.html#">Support</a>
                                        </li>
                                        <li>
                                            <a href="cart.html#">Language</a>
                                        </li>
                                    </ul>
                        ...
                        <div class="header-campaign-activation axil-slick-arrow arrow-both-side header-campaign-arrow">
                            <div class="slick-slide">
                                <div class="campaign-content">
                                    <p>STUDENT NOW GET 10% OFF : <a href="cart.html#">GET OFFER</a></p>
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="campaign-content">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4">
                        <div class="social-share">
                            ...
                            <a href="cart.html#"><i class="fab fa-discord"></i></a>
                        </div>
                    </div>
                                    ...
                                    <div class="inner">
                                        <div class="product-rating">
                                            ...
                                            <div class="review-link">
                                                <a href="cart.html#">(<span>1</span> customer reviews)</a>
                                            </div>
                                        </div>
