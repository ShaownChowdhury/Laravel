...
<![endif]-->
    <a href="contact.html#top" class="back-to-top" id="backto-top"><i class="fal fa-arrow-up"></i></a>
    <!-- Start Header -->
                        ...
                        <div class="header-top-dropdown">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="contact.html#">Arabic</a></li>
                                    <li><a class="dropdown-item" href="contact.html#">Spanish</a></li>
                                </ul>
                            </div>
                            <div class="dropdown">
                                <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="contact.html#">USD</a></li>
                                    <li><a class="dropdown-item" href="contact.html#">AUD</a></li>
                                    <li><a class="dropdown-item" href="contact.html#">EUR</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="header-action">
                        <ul class="action-list">
                            ...
                            <li class="shopping-cart">
                                <a href="contact.html#" class="cart-dropdown-btn">
                            ...
                            <li class="my-account">
                                ...
                                <div class="my-account-dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="contact.html#">Initiate return</a>
                                        </li>
                                        <li>
                                            <a href="contact.html#">Support</a>
                                        </li>
                                        <li>
                                            <a href="contact.html#">Language</a>
                                        </li>
                                    </ul>
                        ...
                        <div class="header-campaign-activation axil-slick-arrow arrow-both-side header-campaign-arrow">
                            <div class="slick-slide">
                                <div class="campaign-content">
                                    <p>STUDENT NOW GET 10% OFF : <a href="contact.html#">GET OFFER</a></p>
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="campaign-content">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4">
                        <div class="social-share">
                            ...
                            <a href="contact.html#"><i class="fab fa-discord"></i></a>
                        </div>
                    </div>
                                    ...
                                    <div class="inner">
                                        <div class="product-rating">
                                            ...
                                            <div class="review-link">
                                                <a href="contact.html#">(<span>1</span> customer reviews)</a>
                                            </div>
                                        </div>
